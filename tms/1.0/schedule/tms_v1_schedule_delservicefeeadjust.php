...
<?php
	...
	//	}
		if ($query) {
			echo "<script>alert('删除成功！ 请返回。');location.assign('tms_v1_schedule_modservicefee.php?clnumber=$clnumber1');</script>";
		}else{
			echo "<script>alert('删除失败！');location.assign('tms_v1_schedule_modservicefee.php?clnumber=$clnumber1');</script>";
		}
	}
?>