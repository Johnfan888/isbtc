...
?>
<div id="addlinesite">
<form name="form1" action="tms_v1_schedule_modnorunsdockok.php" method="post">
<table width="40%" align="center" class="main_tableboder" border="1" cellpadding="3" cellspacing="1">
	...
	<tr> 
    	...
    	<td bgcolor="#FFFFFF"><input type="checkbox" name="IsGetOnSit" id="IsGetOnSit" <?php if($result['nds_GetOnSite']!=0)echo "checked";?> onclick="getvalue(this.id,'GetOnSite')"/>是否上车点</td>
	</tr> 
	<tr> 
...
-->
   ...
   <tr>
    <td colspan="2" align="center" bgcolor="#FFFFFF"><input name="mod" id="mod" type="button" value="提交" onclick="return addlinesite()"/ />
