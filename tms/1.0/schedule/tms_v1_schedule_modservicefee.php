...
function addservicefeeadjust(){
	window.location.href='tms_v1_schedule_addservicefeeadjust.php?clnumber1='+document.getElementById("NoOfRunsID").value+'&clnumber2='+document.getElementById("LineID").value;	
}
function retur(){
	window.close();
}
function delservicefeeadjust(){
	if (!document.getElementById("ID1").value){
		...
		if(!confirm("确定要删除该班次数据吗？")){
			...
			window.location.href='tms_v1_schedule_delservicefeeadjust.php?op=del&clnumber='+document.getElementById("ID1").value+'&clnumber1='+document.getElementById("NoOfRunsID1").value
		}
	}
}
function modservicefeeadjust(){
	if (!document.getElementById("ID1").value){
		...
		window.location.href='tms_v1_schedule_modservicefeeadjust.php?op=mod&clnumber='+document.getElementById("ID1").value
	}
}
</script>
</head>
...
<table width="100%" align="center" class="main_tableboder" border="1" cellpadding="3" cellspacing="1">
 <tr>
    ...
    <td colspan="2" bgcolor="#FFFFFF">
    	...
    	&nbsp;&nbsp;&nbsp;<input name="button4" type="button" value="关闭" onclick="retur()"/>
    </td>
  </tr>
</table>
