		...
		jQuery.get(
				...
				function(data){
					...
					if( objData.sucess=='0'){
						...
						document.getElementById("IsServiceFee").value=1
						document.getElementById("Fees").style.display=""	
						document.getElementById("GetOnSit").checked=true;	
...
?>
<div id="addlinesite">
<form name="form1" action="tms_v1_basedata_addnorunsdockok.php" method="post">
<table width="40%" align="center" class="main_tableboder" border="1" cellpadding="3" cellspacing="1">
	...
	<tr> 
    	...
    	<td bgcolor="#FFFFFF"><input type="checkbox" name="GetOnSit"id="GetOnSit" checked="checked" onclick="getvalueup(this.id,'GetOnSite')"/>是否上车点</td>
	</tr> 
	<tr> 
	...
	<tr> 
    	...
    	<td bgcolor="#FFFFFF"><input name="otherFee3" id="otherFee3" type="text"  size="10" onkeyup="return isnum(this.value,this.id)" />%
	</tr> 
<!-- 
	<tr> 
