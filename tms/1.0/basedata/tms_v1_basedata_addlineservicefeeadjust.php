...
<script type="text/javascript" src="tms_v1_basedata_addline.js"></script>
...
/*	$("#ModelID").keyup(function(){
	...
	$("#add").click(function(){
		...
		jQuery.get(
			'tms_v1_basedata_addlineservicefeeadjustok.php',
			{'op': 'addlineservice', 'LineAdjust':$("#LineAdjust").val(), 'ISUnitAdjust':$("#ISUnitAdjust").val(),'ISLineAdjust':$("#ISLineAdjust").val(),
			...
			//	alert(data);
				...
				if(objData.retVal=='FAIL'){
					...
					if(objData.retVal=='FAIL1'){
						...
						alert(objData.retString);
						window.location.href='tms_v1_basedata_addlineservicefeeadjust.php?clnumber='+document.getElementById("LineAdjust").value;
					}
				}
		});
	});
...
<table width="40%" align="center" class="main_tableboder" border="1" cellpadding="3" cellspacing="1">
	<tr>
		...
		<td bgcolor="#FFFFFF"><input type="hidden" name="LineAdjust" id="LineAdjust"  value="<?php echo $clnumber;?>"/>
		<input type="text" style="width:230px;" name="LineAdjust1" id="LineAdjust1" disabled="disabled" value="<?php echo $clnumber;?>"/></td>
	</tr>
	<tr>
...
<!-- 
	<tr> 
    	...
    	<td bgcolor="#FFFFFF">
    		...
    		<span style="color:red">*</span>
    		<br/>
	    	<select id="Modleselect" name="Modleselect" class="helplay" multiple="multiple" style="display:none;height:90px" size="20" ></select>
    	</td>
	</tr> 
	<tr> 
    	<td nowrap="nowrap" bgcolor="#FFFFFF"><span class="form_title"><img src="../ui/images/sj.gif" width="6" height="7" />车型名：</span></td>
    	<td bgcolor="#FFFFFF"><input type="text" name="Model" id="Model" readonly="readonly"/></td>
	</tr>
 -->  
	<tr> 
