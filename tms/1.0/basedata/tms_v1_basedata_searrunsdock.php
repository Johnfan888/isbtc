...
function delnorunsdock(){
	if (!document.getElementById("ID1").value){
		...
		if(!confirm("确定要删除该停靠点吗？")){
			...
			window.location.href='tms_v1_basedata_delnorunsdock.php?op=del&NoOfRunsID='+document.getElementById("NoOfRunsID1").value+'&noid='+document.getElementById("ID1").value;
		}
	}
}
function modnorunsdock(){
	if (!document.getElementById("ID1").value){
		...
		if(document.getElementById("ID1").value=='1' || document.getElementById("ID1").value==document.getElementById("number").value){
			window.location.href='tms_v1_basedata_modnorunsdock1.php?op=mod&NoOfRunsID='+document.getElementById("NoOfRunsID1").value+'&noid='+document.getElementById("ID1").value;
		}else{
			window.location.href='tms_v1_basedata_modnorunsdock.php?op=mod&NoOfRunsID='+document.getElementById("NoOfRunsID1").value+'&noid='+document.getElementById("ID1").value;
		}
	}
} 
</script>
...
<div id="menu" style="display: none">   
	<ul>   
		<li><a href="tms_v1_basedata_addnorunsdock.php?NoOfRunsID=<?php echo $results['nri_NoOfRunsID'];?>&LineID=<?php echo $results['nri_LineID'];?>">添加停靠点</a></li>   
