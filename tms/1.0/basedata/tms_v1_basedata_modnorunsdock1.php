...
?>
<div id="addlinesite">
<form action="tms_v1_basedata_modnorunsdockok.php" method="post" name="form1">
<table width="40%" align="center" class="main_tableboder" border="1" cellpadding="3" cellspacing="1">
	...
	<tr> 
    	...
    	<td bgcolor="#FFFFFF">
    		...
    		<input type="text" name="RunHour" id="RunHour"  style="width:50px;" disabled="disabled" value="<?php if($RunHours[0]) echo $RunHours[0]; ?>" onkeyup="return isnumber(this.value,this.id)"/>小时
    		<input type="hidden" name="RunMinuts" id="RunMinuts"  style="width:50px;" value="<?php if($RunHours[1]) echo $RunHours[1];?>" onkeyup="return isnumber(this.value,this.id)"/>
    		<input type="text" name="RunMinut" id="RunMinut"  style="width:50px;" disabled="disabled" value="<?php if($RunHours[1]) echo $RunHours[1];?>" onkeyup="return isnumber(this.value,this.id)"/>分钟
    		<br />
...
-->
   ...
   <tr>
    <td colspan="2" align="center" bgcolor="#FFFFFF"><input name="button0" type="button" value="提交" onclick="return addlinesite()"/>
