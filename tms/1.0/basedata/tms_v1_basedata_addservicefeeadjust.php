...
$(document).ready(function(){
	...
	$("#add").click(function(){
		...
		jQuery.get(
			'tms_v1_basedata_addservicefeeadjustok.php',
			...
			function(data){
				...
				if(objData.retVal=='FAIL'){
					...
					if(objData.retVal=='FAIL1'){
						...
						alert(objData.retString);
						window.location.href='tms_v1_basedata_addservicefeeadjust.php?clnumber1='+document.getElementById("NoRunsAdjust").value+'&clnumber2='+document.getElementById("LineAdjust").value;
					}
				}
		}); 
	});
