...
//销票界面
	...
	$sql="SELECT * FROM tms_bd_TicketProvide where tp_ID='{$clnumber}'";
...
//		proc.moveTo((width-560)/2,(height-339)/2);
	}
</script>
...
<table width="40%" align="center" class="main_tableboder" border="1" cellpadding="3" cellspacing="1">
	<tr>
        ...
        <td bgcolor="#FFFFFF"><input name="BeginTicket" id="BeginTicket" type="hidden" value="<?php echo $row['tp_CurrentTicket'];?>"/>
        		<input name="ID" id="ID" type="hidden" value="<?php echo $row['tp_ID'];?>"/>
        		<input name="InceptUserID" id="InceptUserID" type="hidden" value="<?php echo $row['tp_InceptUserID'];?>"/>
        		<input name="InceptUser" id="InceptUser" type="hidden" value="<?php echo $row['tp_InceptUser'];?>"/>
        		<input name="UserSation" id="UserSation" type="hidden" value="<?php echo $row['tp_UserSation'];?>"/>
        		<input name="ProvideData" id="ProvideData" type="hidden" value="<?php echo $row['tp_ProvideData'];?>"/>
        		<input name="LostNum" id="LostNum" type="hidden" value="<?php echo $row['tp_InceptTicketNum'];?>"/>
        		<input name="ACurrentTicket" id="ACurrentTicket" type="hidden" />
        		<input name="BeginTicke" id="BeginTicke" type="text" disabled="disabled" value="<?php echo $row['tp_CurrentTicket'];?>"/></td>
	</tr>
	<tr> 
	...
	<tr> 	
    	...
    	<td bgcolor="#FFFFFF"><input name="Type" id="Type" type="hidden" value="<?php echo $row['tp_Type'];?>"/>
    			<input name="Typ" id="Typ" type="text" disabled="disabled" value="<?php echo $row['tp_Type'];?>"/></td>
	</tr>
	<tr> 	
    	<td nowrap="nowrap" bgcolor="#FFFFFF"><span class="form_title"><img src="../ui/images/sj.gif" width="6" height="7" />销票原因：</span></td>
    	<td nowrap="nowrap" bgcolor="#FFFFFF"><input type="text" name="delreason" id="delreason"/>
