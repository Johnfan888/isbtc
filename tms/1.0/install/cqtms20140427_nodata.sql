...
CREATE TABLE `tms_bd_NoRunsDockSite` (
  ...
  `nds_CheckTicketWindow` tinyint(4) default NULL,
...
CREATE TABLE `tms_bd_NoRunsInfo` (
  ...
  `nri_RunHours` tinyint(4) default NULL,
  ...
  `nri_CheckTicketWindow` int(11) default NULL,
  `nri_SellWindow` int(11) default NULL,
...
CREATE TABLE `tms_bd_SectionInfo` (
  ...
  `si_SectionID` varchar(10) NOT NULL,
...
CREATE TABLE `tms_sch_Report` (
  `rt_NoOfRunsID` varchar(20) NOT NULL default '',
  `rt_LineID` varchar(30) default NULL,
  `rt_NoOfRunsdate` char(10) NOT NULL default '',
  ...
  `rt_BusID` varchar(20) NOT NULL default '',
  ...
  `rt_Remark` varchar(500) default NULL,
...
CREATE TABLE `tms_sch_SpeechNoOfRunsID` (
  ...
  `sn_BusType` varchar(50) default NULL,
  `sn_BusUnit` varchar(50) default NULL,
  `sn_NoOfRunsIDType` varchar(20) default NULL,
  `sn_Degree` int(11) default NULL,
  `sn_Type` varchar(50) default NULL,
  PRIMARY KEY  (`sn_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
-- Dump completed on 2014-04-27  2:30:04
